 ...
 * @param [in,out]   location               Struct containing the geographic location to compute the position for
 ...
 *
 * @param [in]     computeDistance  Compute distance to the Sun (in AU): 0-no, 1-yes
 * @param [in,out]  position  Position of the Sun
 */
 ...
 * @param [in,out] position  Position of the Sun (rad)
 */
 ...
 *
 * @param [in,out] azimuth                Azimuth ("wind direction") of the Sun (rad)
 * @param [in,out] hourAngle              Hour angle of the Sun (rad)
 ...
 *
 * @param [in,out] altitude               Altitude of the Sun above the horizon (rad->deg)
 * @param [in,out] hourAngle              Hour angle of the Sun (rad->deg)
 * @param [in,out] declination            Declination of the Sun (rad->deg)
 * @param [in]    computeRefrEquatorial  Compute refraction correction for equatorial coordinates
 */
